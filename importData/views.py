...
def importData(request):
    ...
    #             grade.year = Year.objects.get(year= '2026')
...
#     count = 0
#     for i in range(2, 1430):
#         national_id = ws['C'+str(i)].value
        
#         try:
#             amount = Part.objects.get(number= int(ws['I'+str(i)].value))
#         except:
#             print(national_id + " I")

#         try:
#             ahkam = ws['K'+str(i)].value
#         except:
#             ahkam = "لا يوجد"
