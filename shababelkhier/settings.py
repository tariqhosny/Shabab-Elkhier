"""
Django settings for shababelkhier project.
...
MIDDLEWARE = [
    ...
    'middleware.custom_csrf_middleware.CustomCsrfViewMiddleware',
]
...
WSGI_APPLICATION = 'shababelkhier.wsgi.application'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'shababelkhier/static')
]
